...
async def all(ctx, route_id: str):
    ...
    BUS_LINES = {
        "5","7","7E","7G","8E","9","10","11","13","13A","15","16","16A",
        "20E","21","21A","22","22A","25","26","27","29","30","30A","31",
        "32","33","33A","34","35","36","38","38A","39","40","40B","40E",
        "44","45","46","54","53","55","57","58","59","60B","63","64B",
        "64","64A","65","65A","66","66B","66E","67","68","71","84E",
        "85","85E","87","87A","88","88A","89E","91","92A","92","93",
        "93A","94E","95","96","97E","98","98E","99","100E"
    }
    ...
    async with aiohttp.ClientSession() as session:
        ...
        for v in vehicles:
            ...
            # ─────────────────────────────
            # FONTOS: eredeti rendszám NEM módosul
            # ─────────────────────────────
            raw_reg = (v.get("license_plate") or "").strip().upper()
            if not raw_reg:
                continue
            ...
            # PÓTLÓ DETEKTÁLÁS
            # ─────────────────────────────
            replacement = is_replacement_vehicle(route_id, raw_reg, model)
